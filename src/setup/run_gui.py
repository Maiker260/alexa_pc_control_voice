from tkinter import *
from src.setup.gui.on_submit import create_on_submit
from src.setup.gui.start_setup import create_start_setup
from src.setup.gui.log_to_ui import create_logger
