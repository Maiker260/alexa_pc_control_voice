...
class RestartPcHandler(AbstractRequestHandler):
    "Handler to restart the PC"
    def can_handle(self, handler_input):
        return ask_utils.is_intent_name("RestartPcIntent")(handler_input)
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Servido mi Rey, ya le reinicio el megazord."
