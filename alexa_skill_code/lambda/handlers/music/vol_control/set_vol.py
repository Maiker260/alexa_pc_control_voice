...
class SetVolHandler(AbstractRequestHandler):
    "Handler to control the volume"
    def can_handle(self, handler_input):
        return ask_utils.is_intent_name("SetVolIntent")(handler_input)
    ...
    def handle(self, handler_input):
        ...
        speak_output = f"Servido mi Rey, ya le pongo el volumen en {vol_value}"
